...
def explain_prediction(probability, input_dict, surname):
    ...
    prompt = f"""You are an expert data scientist at a bank, where you specialiaze in interpreting and explaining predictions of machine learning models.
  ...
  - If the customer has less than 40% risk of churning, generate a 3 sentance explanation of why they might not be at risk of churning.
...
def generate_email(probability, input_dict, explanation, surname):
  ...
  Here is some the customer's information:
  {input_dict}
...
selected_customers_option = st.selectbox("Select a customer", customers)

if selected_customers_option:

  selected_customer_id = int(selected_customers_option.split(" - ")[0])

  print("Selected Customer ID", selected_customer_id)

  selected_surname = selected_customers_option.split(" - ")[1]
